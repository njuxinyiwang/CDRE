...
def parse_relations(relation_info_file, tokenizer, seen_relations):
    ...
    for rel in seen_relations:
        if rel != "No relation":
            relation = relation_info[rel]['name'] + ": " + relation_info[rel]['description']
    ...
    return encoded_relations['input_ids'], encoded_relations['attention_mask']